...
GOODS: List[Good] = [
    ...
    Good("TV", 800, 0.3, "standard", "electronics", 2),
    Good("Computer", 1200, 0.3, "standard", "electronics", 2),
    Good("Printer", 300, 0.3, "standard", "electronics", 1),
    Good("Phone", 600, 0.3, "standard", "electronics", 1),
    Good("Camera", 400, 0.3, "standard", "electronics", 2),
    Good("Laptop", 1500, 0.3, "standard", "electronics", 2),
    Good("Tablet", 500, 0.3, "standard", "electronics", 2),
    Good("Console", 450, 0.3, "standard", "electronics", 2),
    Good("Headphones", 150, 0.3, "standard", "electronics", 1),
    Good("Smartwatch", 400, 0.3, "standard", "electronics", 1),
    Good("VR Headset", 700, 0.3, "standard", "electronics", 2),
    Good("Coffee Machine", 450, 0.3, "standard", "electronics", 2),
    ...
    Good("Luxury Watch", 6000, 0.6, "luxury", "jewelry", 2),
    Good("Diamond Necklace", 8000, 0.7, "luxury", "jewelry", 2),
    Good("Gaming Laptop", 3000, 0.5, "luxury", "electronics", 2),
    Good("High-end Drone", 2500, 0.5, "luxury", "electronics", 2),
    Good("4K OLED TV", 2500, 0.4, "luxury", "electronics", 2),
    # Cars - Large size (15-30 slots)
    Good("Fiat", 20000, 0.3, "standard", "cars", 10),
    Good("Opel Astra", 40000, 0.3, "standard", "cars", 10),
    Good("Ford Focus", 50000, 0.3, "standard", "cars", 10),
    Good("Ferrari", 100000, 0.5, "luxury", "cars", 15),
    Good("Bentley", 200000, 0.5, "luxury", "cars", 15),
    Good("Bugatti", 300000, 0.6, "luxury", "cars", 15),
    # Contraband - Drugs (10-15 slots)
    Good("Weed", 500, 0.8, "contraband", "drugs", 1),
    Good("Cocaine", 2000, 1.0, "contraband", "drugs", 2),
    # Contraband - Weapons (10-15 slots)
    Good("Grenade", 100, 0.9, "contraband", "weapons", 1),
    Good("Pistol", 500, 0.8, "contraband", "weapons", 2),
    Good("Shotgun", 1000, 0.9, "contraband", "weapons", 2),
]
